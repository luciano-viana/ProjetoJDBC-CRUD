...
public class TesteBancojdbc {
	...
	// -----------------------INSERT TABELA USUARIO-----------------------
		...
		public void initBanco() {// metodo de insert
			...
			userposjava.setNome("Pedro6");
			userposjava.setEmail("pedro6@gmail.com");
		...
		public void initbuscar() {
			...
			try {
				Userposjava userposjava = dao.buscar(19L); // irá retornar um objeto
				System.out.println(userposjava);
			} catch (Exception e) {
				e.printStackTrace();
			}
		...
		public void initAtualizar() {
			try {
			UserPosDAO dao = new UserPosDAO();
			Userposjava objetoBanco = dao.buscar(19L);
		...
		public void testeInsertTelefone() {
			...
			telefone.setNumero("(11)2245-1048");
			telefone.setTipo("comercial");
			telefone.setUsuario(17L);//Tem que ser um id de usuário que já existe no banco de dados
		...
		public void testeCarregaFoneUser() {
			...
			List<BeanUserFone> beanUserFones  = dao.lisBeanUserFones(17L);
